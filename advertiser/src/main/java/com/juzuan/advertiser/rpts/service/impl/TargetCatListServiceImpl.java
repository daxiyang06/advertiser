...
public class TargetCatListServiceImpl implements TargetCatListService {
    ...
    public String TargetCatList(){
        ...
        for (CampaignList cl: campaignLists) {
            TaobaoAuthorizeUser taobaoAuthorizeUser = taobaoAuthorizeUserMapper.selectByUserId(cl.getTaobaoUserId());
            ...
            req.setCampaignType(cl.getCampaignType());
            ...
            if (dto == null){
                ...
                for (TargetCatList tcl: targetCatLists) {
                    tcl.setCampaignType(cl.getCampaignType());
                    //将数组数据插入表
